...
<head>
    ...
    <link href="<?php base_url() ?>assets/admin/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="<?php base_url() ?>assets/admin/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="<?php base_url() ?>assets/admin/vendor/chart.js/Chart.min.js"></script>
