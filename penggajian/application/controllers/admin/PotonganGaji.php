...
class PotonganGaji extends CI_Controller{
	...
	{
		$this->form_validation->set_rules('potongan','potongan','required',['required' => 'nama potongan wajib diisi!']);
		$this->form_validation->set_rules('jml_potongan','jml_potongan','required',['required' => 'jumlah potongan wajib diisi!']);
	}

	public function deleteData($id)
	{
		$where = array('id' => $id);
		$this->penggajianModel->hapus_data($where,'potongan_gaji');
		$this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
